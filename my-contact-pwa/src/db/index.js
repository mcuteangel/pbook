...
db.version(3).stores({
  ...
  contacts: '++id, name, lastName, phone, group, createdAt, updatedAt, birthDate, *additionalPhones, *addresses, *customFields', // customFields رو اضافه کن
  groups: '++id, &name',
...
console.log('دیتابیس Dexie تعریف شد (نسخه 3)!');
